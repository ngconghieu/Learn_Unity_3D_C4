...
namespace NaughtyCharacter
{
    ...
    public class PlayerController : Controller
    {
        ...
        {
            _playerInput = FindAnyObjectByType<PlayerInputComponent>();
        ...
        public override void OnCharacterFixedUpdate()
        {
            ...
            _playerCamera.SetControlRotation(Character.GetControlRotation()); //Set rotation of camera
        }

        private void UpdateControlRotation()
        {
            Vector2 camInput = _playerInput.CameraInput; //get camera input
            Vector2 controlRotation = Character.GetControlRotation(); //get vertical rotation
